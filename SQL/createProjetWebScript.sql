...
-- -----------------------------------------------------
-- Table `projetWeb`.`profil`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projetWeb`.`profil` ;

CREATE TABLE IF NOT EXISTS `projetWeb`.`profil` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nomFichier` VARCHAR(45) NULL,
  `contenuFichier` MEDIUMBLOB NULL,
  `information` VARCHAR(45) NOT NULL,
  `date` VARCHAR(45) NOT NULL,
  `patient_id` INT UNSIGNED NOT NULL,
  `medecin_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_fichier_patient1_idx` (`patient_id` ASC),
  INDEX `fk_profil_medecin1_idx` (`medecin_id` ASC),
  CONSTRAINT `fk_fichier_patient1`
    FOREIGN KEY (`patient_id`)
    REFERENCES `projetWeb`.`patient` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_profil_medecin1`
    FOREIGN KEY (`medecin_id`)
    REFERENCES `projetWeb`.`medecin` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
